...
from forecastingchallenge import db, bcrypt
from forecastingchallenge.models import User, Post
from forecastingchallenge.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm,
                                              ResetPasswordForm)
from forecastingchallenge.users.utils import save_picture, delete_picture, send_reset_email
...
def reset_password(token):
    ...
    if user is None:
        flash('That is an invalid or expired password reset', 'warning')
