...
from forecastingchallenge import app, db, bcrypt, mail
from forecastingchallenge.forms import (RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm,
                                        ResetPasswordForm)
